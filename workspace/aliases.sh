...
alias g.pho="git push origin"
alias g.pl="git pull"
alias g.ph="git push"
alias g.s="git status"
alias g.ch="git checkout"
alias g.sh="git log"
alias g.rmt="git remote"
alias g.mg="git merge"
alias g.b="git branch"
alias g.f="git fetch"
alias g.d="git diff"
alias g.r-h="git reset --hard"
alias g.r-s="git reset --soft"
### Composer ###
alias c.in="composer init"
alias c.u="composer update"
alias c.i="composer install"
alias c.i-ns="composer install --no-scripts"
alias c.r="composer require"
alias c.da="composer dump-autoload"
alias c.da-o="composer dump-autoload --optimize"
alias c.c="composer clear-cache"
alias c.s="composer search"
alias c.sh="composer show"
### Npm ###
alias n.in="npm init"
alias n.i="npm install"
alias n.i-f="npm install -f"
alias n.i-s="npm install --save"
alias n.i-sd="npm install --save-dev"
alias n.u="npm update"
alias n.s="npm search"
alias n.dev="npm run dev"
alias n.prod="npm run prod"
